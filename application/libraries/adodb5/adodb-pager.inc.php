...
class ADODB_Pager {
	...
	var $gridAttributes = 'border=1 style="width:100%;"';
	...
	{
		echo "<table ".$attributes."><tr><td style='text-align:center;'>",
				$header,
			"</td></tr><tr><td>",
				$grid,
...
class StyledADODB_Pager extends ADODB_Pager{
	function RenderLayout($header,$grid,$footer,$attributes='border=1')
	{
		echo "<form><table ".$attributes."><thead><tr><td style='text-align:center;'>",
				$header,
